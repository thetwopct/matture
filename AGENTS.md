...
- Use WordPress Code Sniffer (PHPCS)
...
- SetTimeout is never the answer to a problem unless I ask you to use it specifically.

## Test

- Use PHP Unit in the /tests folder
- Always integerate in to the full PHP Unit test suite

## Evironment

The environment this plugin is developed under uses WP-ENV to launch the plugin in its own Docker installation.
